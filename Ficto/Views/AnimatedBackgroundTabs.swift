//
//  AnimatedBackgroundTabs.swift
//  Inkspire
//
//  Created by Mehdi Javdaneh on 17/03/25.
//

import SwiftUI

struct AnimatedBackgroundTabs: View {
...
struct GalaxyCoreViewTabs: View {
